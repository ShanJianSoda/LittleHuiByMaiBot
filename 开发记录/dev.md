...
- [ ] （部分）**记忆模块的数据应该有时间性，也就是增删改查都有时间、简略的意图附带以及元信息**
...
- [ ] 
  ...
  ```
  03-16 23:46:58 [info] 小绘精灵 | 接收 <- 群聊 [Penacony Paperfold University College(877283684)] [你想何出怎样的意味(280
  4123155)] [回复消息 [你想复读出怎样的喵喵(1962560763)] 你的上班不会是陪小妹妹吧] @你想复读出怎样的喵喵 (0)  再没有了
  03-16 23:46:58 [warn] 小绘精灵 | 快速回复，跳过方法1查询，序号: 399040, 消息数: 1
  03-16 23:46:58 [error] 小绘精灵 | 所有查找方法均失败，获取不到带记录的引用消息 399040
  03-16 23:47:07 [info] 小绘精灵 | 接收 <- 群聊 [Penacony Paperfold University College(877283684)] [你想何出怎样的意味(280
  4123155)] 注定是孤独一生的啊
  ```
  
- [ ] 消息 链接解析 如解析网易云链接 然后自己去联网搜索歌词、背景之类的 （不重要的功能）
...
git pull --no-rebase origin old-version
